...
Future<void> main() async {
  ...
  if (Platform.isLinux || Platform.isWindows) {
    ...
    WindowOptions windowOptions = const WindowOptions(
      ...
      center: true,
      title: 'RedCloud VPN - Next-Gen Anti-Censorship Client for Linux',
      skipTaskbar: false,
    );
...
class _MainLayoutContentState extends State<MainLayoutContent> with WindowListener, TrayListener, TickerProviderStateMixin {
  ...
  final TextEditingController _binaryPathController = TextEditingController(text: 'sing-box');
  final TextEditingController _aetherPathController = TextEditingController(text: 'aether');
  final TextEditingController _torPathController = TextEditingController(text: 'tor');
  final TextEditingController _psiphonPathController = TextEditingController(text: 'psiphon-tunnel-core');
  ...
  Future<void> _checkStatus() async {
    ...
    setState(() {
      ...
      if (activeHybrid) {
        ...
        _statusMessage = "تنظیمات دی‌ان‌اس بر روی سیستم لینوکس فعال است.";
      } else {
      ...
      if (Platform.isLinux || Platform.isWindows) {
        if (_isHybridRunning || _isProxyRunning) {
          ...
          if (_isHybridModeEnabled) {
            setState(() {
              _statusMessage = "در حال ایجاد پل چرخشی اِتر و زنجیره‌سازی با Sing-box در لینوکس...";
            });
  ...
  Future<void> _toggleDnsConnection() async {
    try {
      ...
      setState(() {
        _isDnsRunning = false;
        _statusMessage = "خطا در تنظیم DNS: $e (نرم‌افزار را با دسترسی مناسب یا sudo اجرا کنید)";
      });
    }
  }
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Center(
                      child: Text('نسخه ضدسانسور ۳.۵ لینوکس (Hybrid)', style: TextStyle(color: Colors.grey, fontSize: 10)),
                    )
                  ],
                ),
              ),
          ...
          children: [
            const Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text('کنترل ترافیک با قابلیت زنجیره‌سازی خودکار از دل پل ضدسانسور اِتر در لینوکس', style: TextStyle(color: Colors.grey, fontSize: 13)),
              ],
            ),
                    ...
                    children: [
                      ...
                      _buildGlassContainer(
                        ...
                        child: SwitchListTile(
                          ...
                          subtitle: const Text('پیکربندی محیط‌های GNOME (کالی/اوبونتو/دبیان) و KDE جهت عبور ترافیک', style: TextStyle(fontSize: 11, color: Colors.grey)),
                      ...
                      _buildGlassContainer(
                        ...
                        child: SwitchListTile(
                          ...
                          subtitle: const Text('عبور ترافیک کل سیستم لینوکس از طریق رابط /dev/net/tun', style: TextStyle(fontSize: 11, color: Colors.grey)),
                          value: _useTunMode,
                    ...
                    children: [
                      ...
                      _buildGlassContainer(
                        ...
                        child: SwitchListTile(
                          ...
                          subtitle: const Text('هدایت خودکار ترافیک مرورگرهای لینوکس به درگاه Aether', style: TextStyle(fontSize: 11, color: Colors.grey)),
                          value: _useSystemProxy,
                          activeThumbColor: const Color(0xFF00D2FF),
          ...
          children: [
            const Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text('اتصال فوق‌امن و گمنام در لینوکس با امکان گذر از گارد ضدسانسور MASQUE و تعیین کشور خروجی', style: TextStyle(color: Colors.grey, fontSize: 13)),
              ],
            ),
            _buildGlassContainer(
              padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8),
                    ...
                    children: [
                      ...
                      _buildGlassContainer(
                        ...
                        child: SwitchListTile(
                          ...
                          subtitle: const Text('فعال‌سازی تنظیمات پروکسی لینوکس جهت عبور کل ترافیک سیستم', style: TextStyle(fontSize: 11, color: Colors.grey)),
                          value: _useSystemProxy,
                          activeThumbColor: const Color(0xFFE94057),
          ...
          children: [
            const Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text('اتصال امن به فیلترشکن سایفون با امکان گذر از بستر پرسرعت و پایدار MASQUE در لینوکس', style: TextStyle(color: Colors.grey, fontSize: 13)),
              ],
            ),
            _buildGlassContainer(
              padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8),
  ...
  Widget _buildDnsPage() {
    return Column(
      ...
      children: [
        ...
        const Text('اعمال دی‌ان‌اس‌های تحریم‌شکن در لینوکس با بررسی زنده پینگ و تاخیر شبکه', style: TextStyle(color: Colors.grey, fontSize: 13)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          const Text('اسکن دو‌حالته سریع و عمیق با پایش زنده TCP Ping و TLS Handshake در لینوکس', style: TextStyle(color: Colors.grey, fontSize: 12)),
          const SizedBox(height: 20),
  ...
  Widget _buildSettingsPage() {
    return Column(
      ...
      children: [
        ...
        const Text('پیکربندی هسته‌های سیستم و مسیر فایل‌های باینری لینوکس', style: TextStyle(color: Colors.grey, fontSize: 13)),
        const SizedBox(height: 24),
        Expanded(
          child: SingleChildScrollView(
            child: _buildGlassContainer(
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'مسیر یا دستور باینری aether',
                      border: OutlineInputBorder(),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'مسیر یا دستور باینری sing-box',
                      border: OutlineInputBorder(),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'مسیر یا دستور باینری tor',
                      border: OutlineInputBorder(),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'مسیر یا دستور باینری psiphon-tunnel-core',
                      border: OutlineInputBorder(),
                  ...
                  const Divider(color: Colors.white12),
                  const SizedBox(height: 16),
                  const Text('سیستم‌عامل مقصد فعلی: Linux (Kali / BlackArch / Debian / Arch / Ubuntu)', style: TextStyle(color: Colors.grey, fontSize: 13)),
                ],
              ),
            ),
          ),
        ...
        Row(
          children: [
            ...
            const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('راهنمای جامع کاربری RedCloud در لینوکس', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                Text('آموزش گام‌به‌گام تمامی ابزارها، پروتکل‌ها و تکنیک‌های دور زدن فیلترینگ در کلیه توزیع‌ها', style: TextStyle(color: Colors.grey, fontSize: 12)),
              ],
            ),
          ],
        ),
...
این حالت پیشرفته‌ترین متد ضدسانسور برنامه در لینوکس است. در این حالت ترافیک شما ابتدا از پل فوق‌العاده پایدار اتر (MASQUE) رد شده و سپس وارد هسته ویتوری (Sing-box) می‌شود. با این کار سیستم فیلترینگ هویت ترافیک شما را متوجه نمی‌شود.
...
''',
                ...
                _buildHelpAccordion(
                  title: '۲. تفاوت کارت شبکه مجازی (TUN Mode) و پروکسی سیستم در لینوکس',
                  icon: Icons.alt_route_rounded,
                  iconColor: const Color(0xFF2DCA73),
                  content: '''
• حالت پروکسی سیستم‌عامل (System Proxy):
از ابزارهای استاندارد دسکتاپ‌های لینوکس (مانند gsettings در کالی، اوبونتو و دبیان یا kwriteconfig در KDE) برای هدایت ترافیک مرورگرها (کروم، فایرفاکس) استفاده می‌کند.

• کارت شبکه مجازی (TUN Mode):
یک اینترفیس مجازی شبکه لینوکس (/dev/net/tun) ایجاد می‌کند و کل ترافیک اینترنت سیستم شما (شامل ترمینال، ابزارهای تست نفوذ، SSH، گیت، بازی‌ها و کل پکت‌ها) را بدون نشت DNS و WebRTC از تونل عبور می‌دهد. (برای اجرای بی‌نقص TUN توصیه می‌شود برنامه را با دسترسی ادمین/sudo یا تنظیم setcap اجرا کنید).
''',
                ),
                _buildHelpAccordion(
...
• حالت MASQUE H3 (QUIC):
پرسرعت‌ترین حالت ممکن بر بستر HTTP/3 که بدون تاخیر دست‌دهی اولیه (0-RTT) استریم‌های باکیفیت و وب‌گردی پرسرعت را فراهم می‌کند.
...
گره‌های گارد تور از پل ضدسانسور MASQUE عبور کرده و فیلترینگ گاردها را دور می‌زنند تا ارتباط شما با کشور خروجی دلخواه ۱۰۰٪ برقرار شود.
...
استفاده از فایل cloudflare_IPs.txt و اسکن موازی هزاران آی‌پی از دل رنج‌های CIDR ابری در لینوکس.
''',
                ),
                _buildHelpAccordion(
                  title: '۷. تغییر دهنده هوشمند دی‌ان‌اس در لینوکس (DNS Changer)',
                  icon: Icons.dns_rounded,
                  iconColor: const Color(0xFF6DD5ED),
                  content: '''
این تب به شما اجازه می‌دهد بدون روشن کردن فیلترشکن، تحریم‌های اینترنتی علیه کاربران ایرانی را با تغییر resolvectl یا /etc/resolv.conf دور بزنید!
دی‌ان‌اس‌های معروف مانند شکن، الکترو، ۴۰۳ آنلاین، رادار گیم و همچنین DNSهای فوق امن DoH (کلودفلر، ادگارد، نکست‌دی‌ان‌اس) آماده انتخاب هستند.
''',
                ),
                _buildHelpAccordion(
...
دست‌دهی کلاینت شما را کاملاً شبیه مرورگر گوگل کروم واقعی نشان می‌دهد.

• قطعه‌بندی پکت‌ها (TLS Fragmentation):
پکت ClientHello حاوی نام دامنه (SNI) را به قطعات چند بایتی خرد می‌کند تا سیستم فیلترینگ DPI نتواند مقصد شما را بخواند.
''',
                ),
              ],
            ),
          ...
          children: [
            const Column(
              ...
              children: [
                ...
                Text('تکنیک‌های جعل دست‌دهی TLS و قطعه‌بندی ترافیک در لینوکس', style: TextStyle(color: Colors.grey, fontSize: 12)),
              ],
            ),
            IconButton(
            ...
            child: _buildGlassContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'تغییر اثر انگشت امنیتی ClientHello به شکل مرورگرهای واقعی دسکتاپ لینوکس',
                    style: TextStyle(fontSize: 11, color: Colors.grey[400]),
                  ),
                  const SizedBox(height: 12),
                  Container(
